...
<template>
<div id="banner" style="position: relative; margin: 20px auto;
    top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;" v-show="isBannersFetched">
    ...
    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
        ...
        <div v-for="banner in banners">
            <img u="image" v-bind:src="banner.url" alt="{{banner.alt}}">
            <!--div class='banner_desc'style="position: absolute; width: 100%; height: 120px; top: 300px; left: 00px; padding: 10px;
                text-align: left; line-height: 50px; font-size: 30px;
                    color: #FFFFFF;">
            </div-->
        </div>
    </div>
...
export default {
    ...
    // },
    methods: {
        fetchBanners: function (done) {
            this.$http.get('get/list/banner').then((response) => {
